...
- 首屏核心说明只写人能快速判断项目边界的内容，不展开模块正文。
- 主用户旅程一句话必须能回链到下方用户旅程或业务闭环流程图。
...
| 需要跨团队确认的问题 | 为什么需要研发/跨团队参与 | 来源真源链接 | 来源条款/位置 |
|------|------|------|------|
|  |  |  |  |

- 纯产品内部细节不进入研发宣讲会首屏。
- 只有需要研发或跨团队参与判断的问题，才保留在本节。
...
- `3.2 首屏核心说明与阅读定位`、`3.3 真源回链`、`3.4-3.7` 图示区都必须填写来源真源链接与来源条款/位置，不能只写阅读层自己的概括。
- `3.8 Active 模块总览`、`3.9 分模块主流程图`、`3.10 需要跨团队确认的问题`、`3.11 deferred 里程碑` 都必须填写来源条款/位置。
- `3.10 需要跨团队确认的问题` 与 `3.11 deferred 里程碑` 只做关系说明与链接回链，不展开正文，不得写成独立状态面板。
