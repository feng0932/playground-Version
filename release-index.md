...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.5` | `release` | `released` | `de5acb3c5af3d4d1e6eca2506ba0da5759999f9b` | `releases/v0.4.5/` | `releases/v0.4.5/release-note.md` | Internal raw verification passed on fresh isolated Python; `00 -> 01 -> 10` live proof passed |
