...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.7-Hotfix` | `release` | `exported` | `c4fec04f825ddf07d31f5e3250f06573106526e6` | `releases/v0.4.7-Hotfix/` | `releases/v0.4.7-Hotfix/release-note.md` | Control-chain hotfix: terminal receipt appendix, 01-to-10 module execution gate, and no early child-agent receipt pressure; GitHub release excluded by user |
