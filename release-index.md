...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.6` | `release` | `released` | `07cbf455da5691cf159ae8010a026ff56dc601cd` | `releases/v0.4.6/` | `releases/v0.4.6/release-note.md` | Internal raw assets, stable pointer, install, doctor, and runtime smoke verified; fresh live transcript pending |
