...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.7-Hotfix-1` | `release` | `exported` | `9b759e4d430308697491756d73f150971c53ad1c` | `releases/v0.4.7-Hotfix-1/` | `releases/v0.4.7-Hotfix-1/release-note.md` | Dispatch loop and minimal consumable receipt hotfix: 10 completed no-primary-window next hop waits for user intent; 01/10 machine receipts keep only current validator/consumer-required fields; internal raw assets exported; GitHub release excluded by user |
