...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.7-Hotfix` | `release` | `released` | `8ca54b615ff3b7491b57937ee23382818c7de086` | `releases/v0.4.7-Hotfix/` | `releases/v0.4.7-Hotfix/release-note.md` | Control-chain hotfix plus update-path correction: terminal receipt appendix, 01-to-10 module execution gate, no early child-agent receipt pressure, and same-core Hotfix update allowed by downgrade guard; internal raw assets and stable pointer verified; GitHub release excluded by user |
