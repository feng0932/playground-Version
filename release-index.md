...
| --- | --- | --- | --- | --- | --- | --- |
| `v0.4.5` | `release` | `exported` | `08c7433b39915db5fe97fa1ffb5879710180e9ad` | `releases/v0.4.5/` | `releases/v0.4.5/release-note.md` | Internal-first export staged; pending real install smoke and GitHub auxiliary release |
